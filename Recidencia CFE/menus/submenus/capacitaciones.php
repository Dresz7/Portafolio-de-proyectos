...
//consulta vacaciones 
$tconsulta="SELECT * FROM capacitaciones order by nombre desc;";
...
<div class="form-group pb-2">
    <h2><p class="pmenu">Capacitaciones</p></h2>
...
<div class="table-responsive tablescroll">
    ...
    <thead class="table-dark" style="position: sticky; top: 0; ">
        <tr>
            ...
            <th scope="col">Inicio de capacitación</th>
            <th scope="col">Capacitador</th>
            <th scope="col">Nombre de capacitación</th>
            <th scope="col">Dias de capacitación</th>
            <th scope="col">Fin de capacitación</th>
    ...
    <tbody>
        <?php if ($total_solicitudes>=1) { 
            ...
            ?>
        <tr>
            <th scope="row"><?php echo $mostrar['idcapacitaciones'] ?></th>
            <td><?php echo $mostrar['nombre'] ?></td>
            <td><?php echo $mostrar['apellido'] ?></td>
            <td><?php echo $mostrar['centro_de_trabajo'] ?></td>
            <td><?php echo $mostrar['inicio_de_capacitacion'] ?></td>
            <td><?php echo $mostrar['capacitador'] ?></td>
            <td><?php echo $mostrar['nombre_de_capacitacion'] ?></td>
            <td><?php echo $mostrar['dias_de_capacitacion'] ?></td>
            <td><?php echo $mostrar['fin_de_capacitacion'] ?></td>
        </tr>
        <?php
            }  
        } 
