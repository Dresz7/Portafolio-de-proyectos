...
<h4><p class="pmenu">Seguridad e higiene</p></h4>
<h4>Turbo gas</h4>
<select id="combo1" onchange="mostrarpdf(this,event)"class="form-select form-select-sm" aria-label=".form-select-sm example" style="width: 100%;">
  ...
  <option value="..\..\cfe\minutas\Generacion\Capacitacion\Turbo gas\.pdf">no hay pdf</option>
  <option value="\..\..\cfe\minutas\Generacion\Capacitacion\Turbo gas\.pdf">no hay pdf2</option>
</select>
<h4>GAO</h4>
<select id="combo2" onchange="mostrarpdf(this,event)"class="form-select form-select-sm" aria-label=".form-select-sm example" style="width: 100%;">
  <option value="0" selected>Elija el pdf que desee</option>
  <option value="..\..\cfe\minutas\Generacion\Capacitacion\GAO\.pdf">no hay pdf</option>
  <option value="\..\..\cfe\minutas\Generacion\Capacitacion\GAO\.pdf">no hay pdf2</option>
</select>
