...
/*      $(".active").removeClass("active");
    ...
    $('#contenidotransm').empty();
    $('#contenidotransm').load('submenus/comitemixtoprodtransm.php');
});
//Capacitación
...
/*     $(".active").removeClass("active");
    $("#Navbarnav").addClass("active")
     ...
     $('#contenidotransm').empty();
     $('#contenidotransm').load('submenus/capacitaciontransm.php');
 });
//Seguridad e higiene
...
/*     $(".active").removeClass("active");
    $("#Navbarnav").addClass("active")  
     ...
     $('#contenidotransm').empty();
     $('#contenidotransm').load('submenus/seguridadehigtransm.php');
 }); 
</script>
<div>
    <nav class="navbar navbar-expand-lg navbar-light navbars">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Transmisión</a>
    ...
    <div class="contenido-general" id="contenidotransm">
