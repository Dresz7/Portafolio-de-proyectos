...
<h4><p class="pmenu">Estados Financieros</p></h4>
<select id="combo1" onchange="mostrarpdf(this,event)"class="form-select form-select-sm" aria-label=".form-select-sm example" style="width: 100%;">
  <option value="0" selected>Elija el estado financiero que desee</option>
  <option value="..\..\cfe\Finanzas\EstadosFinancieros\INFORME SEMANAL DE FLUJO DE EFECTIVOS 2021.pdf">INFORME SEMANAL DE FLUJO DE EFECTIVOS 2021</option>
  </select>
<br />
<br />
