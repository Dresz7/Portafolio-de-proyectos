...
<select id="combo1" onchange="mostrarpdf(this,event)"class="form-select form-select-sm" aria-label=".form-select-sm example" style="width: 100%;">
  ...
  <option value="..\..\cfe\minutas\SuministroBasico\SeguridadHigiene\ACTA SESION MENSUAL SEG E HIGIENE332.pdf">ACTA SESION MENSUAL SEG E HIGIENE332</option>
  <option value="..\..\cfe\minutas\SuministroBasico\SeguridadHigiene\ACTA CONSTITUTIVA PROTECCION CIVIL 17012022.pdf">ACTA CONSTITUTIVA PROTECCION CIVIL 17012022</option>
</select>
<br />
<br />
