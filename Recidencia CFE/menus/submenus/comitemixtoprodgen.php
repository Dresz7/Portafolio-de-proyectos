...
<select id="combo1" onchange="mostrarpdf(this,event)"class="form-select form-select-sm" aria-label=".form-select-sm example" style="width: 100%;">
  ...
  <option value="..\..\cfe\minutas\Generacion\ComiteMixto\Turbo gas\.pdf">no hay pdf</option>
  <option value="..\..\cfe\minutas\Generacion\ComiteMixto\Turbo gas\.pdf">no hay pdf2</option>
</select>
<h4>GAO</h4>
